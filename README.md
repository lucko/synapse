...
public class Example extends JavaPlugin {
    ...
    public void onEnable() {
        // 'PermissionService' is intended to replace the functionality provided by the Vault Permissions API.
        ...
        // I guess it'll mostly target PEX and LP - but synapse will provide a default implementation too,
        // so other plugins can make use of contexts even if a supported perms plugin isn't installed.
